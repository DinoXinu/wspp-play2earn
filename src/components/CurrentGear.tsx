...
export default function CurrentGear({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      <h2 className={`${styles.noGapTop} `}>Adopted Pet</h2>
      <div
        style={{
          display: "flex",
          alignItems: "center",
      ...
      >
        ...
        <div style={{ outline: "1px solid grey", borderRadius: 16 }}>
          {playerNft && (
            <ThirdwebNftMedia metadata={playerNft?.metadata} height={"64"} style={{ borderRadius: 16, marginTop: 4}}/>
          )}
        </div>
        ...
        >
          {pickaxe && (
            // @ts-ignore
            <ThirdwebNftMedia metadata={pickaxe.metadata} height={"64"}  style={{ borderRadius: 16, marginTop: 4}}/>
          )}
        </div>
      </div>
      ...
      >
        ...
        <Image src={gifted} height={64} width={64} alt="character-mining" style={{borderRadius:"16px"}} />
